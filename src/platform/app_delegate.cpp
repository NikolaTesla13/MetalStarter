...
void AppDelegate::applicationDidFinishLaunching(
    NS::Notification* pNotification) {
  CGRect frame = (CGRect){{100.0, 100.0}, {1280.0 * 2 / 3, 720.0 * 2 / 3}};
  ...
  _pMtkView->setClearColor(MTL::ClearColor::Make(0.7, 0.1, 0.2, 1.0));
  ...
  _pWindow->setTitle(NS::String::string(
      "Metal Starter Template", NS::StringEncoding::UTF8StringEncoding));
